...
async function placeBid(event: APIGatewayEvent, ctx: Context) {
  ...
  let response;
  try {
    const command = new UpdateCommand(params as never);
...
/**
 * {
  "nickname": "cuongvu3009",
  "name": "cuongvu3009@gmail.com",
  ...
  "updated_at": "2023-10-24T21:29:32.633Z",
  "email": "cuongvu3009@gmail.com",
